...
$sql_or .= "WHERE 1=1 {$order_id} AND order_status<>'payments' AND pay_stat='1'";
...
<div id="page-warpper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">รายการสั่งแจ้งชำระเงิน</h1>
        </div>
    </div>
    <div class="row">
        <div class="col-lg-12">
            <div class="subhead">
                ...
                <a role="button" class="btn btn-default btn-xs" 
                   href="<?php echo $baseUrl; ?>/back/order004">
                ...
                <table class="table table-striped table-custom">
                    <thead>
                        <tr>
                            ...
                            <th id="user-grid_c4">
                                <a class="sort-link" href="<?php echo $uri; ?>">วันที่ชำระเงิน</a>
                            </th>
                            <!-- <th id="user-grid_c4">
                                <a class="sort-link" href="<?php echo $uri; ?>">ผู้สั่งซื้อ</a>
                            </th> -->
                            <th id="user-grid_c4" style="text-align: right;">
                                <a class="sort-link" href="<?php echo $uri; ?>">จำนวนเงิน(บาท)</a>
                            </th>
                        ...
                        while ($rs_or = $db->get($query_or_page)) {
                            ...
                            <tr class="<?php echo $tr; ?>">
                                ...
                                <td class="button-column">
                                    ...
                                    <a class="btn btn-info btn-xs load_data" title="" href="<?php echo $baseUrl; ?>/back/order004/view/<?php echo $rs_or['id']; ?>"><i class="glyphicon glyphicon-zoom-in"></i> รายละเอียด</a>
