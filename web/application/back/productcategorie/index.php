    ...
    <div class="row">
      <div class="col-sm-12">
          <div class="dataTables_paginate paging_simple_numbers" id="example1_paginate">
              <ul class="pagination"><li class="paginate_button active"><a tabindex="0" data-dt-idx="1" aria-controls="itoffside.com" href="#">1</a></li><li class="paginate_button"><a data-ci-pagination-page="2" href="#">2</a></li><li class="paginate_button next"><a rel="next" data-ci-pagination-page="2" href="#">Next</a></li></ul>                            </div>
