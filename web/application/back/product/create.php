        ...
        <div class="col-lg-12">
            <div class="form-horizontal" style="margin-top: 10px;">
                <form id="product-form" action="<?php echo $baseUrl; ?>/back/product/form_create" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="Product_name" class="col-sm-2 control-label required">ศิลปิน <span class="required">*</span></label>
                        <div class="col-sm-4">
                            <input type="text" id="brandname" name="brandname" class="form-control input-sm" data-validation="required">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="Product_image" class="col-sm-2 control-label">รูปภาพประกอบ</label>
                        <div class="col-sm-4">
                            <input type="file" name="photodetail" id="photodetail">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-12">
