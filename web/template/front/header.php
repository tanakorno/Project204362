        ...
        <div class="blog-masthead">
            <div class="container">
                <nav class="blog-nav">
                    ...
                    <a class="blog-nav-item active" href="<?php echo base_url(); ?>/howtopay">แจ้งชำระเงิน</a>
                    <a class="blog-nav-item active" href="<?php echo base_url(); ?>/aboutus">เกี่ยวกับเรา</a>
                <ul class="nav navbar-top-links navbar-right">
                    <li class="dropdown">
                        <a class="dropdown-toggle" href="<?php echo base_url(); ?>/back/product">
                            <i class="glyphicon glyphicon-user"></i> เข้าสู่ระบบจัดการสินค้า
                        </a>
                    </li>
                </ul>
                </nav>
