        ...
        <div id="warpper">
            <nav class="navbar navbar-default navbar-fixed-top" style="margin-bottom: 0;" role="navigation">
                <div class="navbar-header">
                    <a class="navbar-brand" href="<?php echo $baseUrl; ?>/back">WANNABE</a>
                </div>
                ...
                <div class="navbar-default navbar-static-side" role="navigation">
                    <div class="sidebar-collapse">
                        <ul id="side-menu" class="nav">
                            ...
                            <li>
                                <a href="<?php echo $baseUrl; ?>/back/order004"><i class="glyphicon glyphicon-folder-open"></i> รายการแจ้งชำระเงิน</a>
                            </li>
                            <!-- <li>
